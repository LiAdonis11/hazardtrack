...
// Removed framer-motion import, using CSS animations from design system
      ...
      <div className="space-y-3">
        ...
        <div className="h-64 flex items-end justify-between gap-2">
          {Array.from({ length: 7 }).map((_, i) => (
            <div
              key={i}
              className="flex-1 skeleton rounded-t-lg animate-fade-in"
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            key={i}
            className="animate-slide-in-right bg-card border border-border rounded-lg p-4"
            style={{ animationDelay: `${i * 0.1}s` }}
          >
            <div className="flex items-center gap-3">
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div
          key={i}
          className="animate-slide-in-up space-y-2"
          style={{ animationDelay: `${i * 0.1}s` }}
        >
          <SkeletonBase className="h-4 w-24" />
  ...
  return (
    <div className="space-y-4">
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div
          key={i}
          className="animate-fade-in bg-card border border-border rounded-lg p-4 space-y-3"
          style={{ animationDelay: `${i * 0.1}s` }}
        >
          <SkeletonBase className="h-5 w-32" />
          <div className="space-y-2">
  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="animate-slide-in-right flex items-center gap-3 p-3 bg-card border border-border rounded-lg"
          style={{ animationDelay: `${i * 0.05}s` }}
        >
  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div
          key={i}
          className="animate-fade-in bg-card border border-border rounded-xl p-4"
          style={{ animationDelay: `${i * 0.1}s` }}
        >
