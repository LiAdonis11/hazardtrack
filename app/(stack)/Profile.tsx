...
// import { ScrollView, TouchableOpacity, Linking, Alert, KeyboardAvoidingView, Platform, Keyboard } from "react-native"
...
//             totalReports: 0, // Will be calculated from reports
//             resolvedReports: 0, // Will be calculated from reports
...
//         const reportsResponse = await apiGetReports(token)
...
//           const resolvedReports = userReports.filter((r: any) => (r.status || "").toLowerCase() === "resolved").length
...
//                 </Text>
//                 <Text style={{ color: "#777", marginTop: 6 }}>Total Reports</Text>
//               </YStack>
//             </Card>
...
//                 </Text>
//                 <Text style={{ color: "#777", marginTop: 6 }}>Resolved</Text>
//               </YStack>
//             </Card>
//           </XStack>
...
//         onOpenChange={setShowPasswordChangeSheet}
